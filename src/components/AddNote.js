    ...
    <div>
      <div className='container my-3'>
        ...
        <div className="mb-3 my-3">
          ...
          <input type="text" className="form-control" id="title" placeholder="Subject : Lessons No" onChange={onChange} name="title" value={note.title}/>
        </div>
        ...
        <div className="mb-3">
          ...
          <textarea className="form-control" id="description" placeholder="Imp Notice" rows="3" onChange={onChange} name="description" value={note.description}></textarea>
        </div>
